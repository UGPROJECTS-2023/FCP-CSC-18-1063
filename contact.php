      ...
      <!-- Contact 1 start -->
        ...
        <div class="container mt-3">
                                ...
                                <div class="row  mb-3 mx-0">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                        <div class="form-group phonenumber">
                                            <input type="number" id="phonenumber" name="phone" class="form-control" placeholder="Phone number" required autofocus>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                        ...
                        <div class="media-body">
                            ...
                            <p>Line 1<a href="tel:+234 9050449632">:+234 9050449632</a> </p>
