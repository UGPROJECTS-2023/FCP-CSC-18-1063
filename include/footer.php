<footer class="footer">
    <div class="container footer-inner">
            ...
            <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            Phone: <a href="tel:+2349050449632">09050449632</a>
                        </li>
                    </ul>

                    <ul class="social-list clearfix">
                        <li><a href="https://www.facebook.com/bellotybaba" class="facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="row mx-0">
            <div class="col-xl-12">
                <p class="copy">
                <a href="https://www.facebook.com/itechservicesconsultancy" target="_blank">Developed and design by Bello Mahmoud Baba</a>
                <a href="tel:+2349050449632">+2349050449632</a><br>
